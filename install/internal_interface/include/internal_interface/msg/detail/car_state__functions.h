...
#ifndef INTERNAL_INTERFACE__MSG__DETAIL__CAR_STATE__FUNCTIONS_H_
#define INTERNAL_INTERFACE__MSG__DETAIL__CAR_STATE__FUNCTIONS_H_
 ...
 * calls
 * internal_interface__msg__CarState__init().
...
/**
 * It calls
 * internal_interface__msg__CarState__fini()
 ...
 * internal_interface__msg__CarState__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * internal_interface__msg__CarState__Sequence__fini()
 * on the array,
...
#endif  // INTERNAL_INTERFACE__MSG__DETAIL__CAR_STATE__FUNCTIONS_H_
