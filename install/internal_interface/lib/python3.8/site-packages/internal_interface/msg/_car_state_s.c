...
bool internal_interface__msg__car_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("internal_interface.msg._car_state.CarState", full_classname_dest, 42) == 0);
  }
  internal_interface__msg__CarState * ros_message = _ros_message;
  {  // x
...
PyObject * internal_interface__msg__car_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("internal_interface.msg._car_state");
