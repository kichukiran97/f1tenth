...
class Metaclass_Path(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from internal_interface.msg import Node
...
class Path(metaclass=Metaclass_Path):
    ...
    _fields_and_field_types = {
        'nodes': 'sequence<internal_interface/Node>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['internal_interface', 'msg'], 'Node')),  # noqa: E501
    )
