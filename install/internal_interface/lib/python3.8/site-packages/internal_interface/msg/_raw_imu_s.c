...
bool internal_interface__msg__raw_imu__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("internal_interface.msg._raw_imu.RawImu", full_classname_dest, 38) == 0);
  }
  internal_interface__msg__RawImu * ros_message = _ros_message;
  {  // yaw
...
PyObject * internal_interface__msg__raw_imu__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("internal_interface.msg._raw_imu");
