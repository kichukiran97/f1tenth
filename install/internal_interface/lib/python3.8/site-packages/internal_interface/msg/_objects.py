    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'internal_interface.msg.Objects')
            logger.debug(
            ...
            from internal_interface.msg import Object
...
class Objects(metaclass=Metaclass_Objects):
    ...
    _fields_and_field_types = {
        'objects': 'sequence<internal_interface/Object>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['internal_interface', 'msg'], 'Object')),  # noqa: E501
    )
