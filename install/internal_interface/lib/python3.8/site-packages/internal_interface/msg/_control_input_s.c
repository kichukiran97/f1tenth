...
bool internal_interface__msg__control_input__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("internal_interface.msg._control_input.ControlInput", full_classname_dest, 50) == 0);
  }
  internal_interface__msg__ControlInput * ros_message = _ros_message;
  {  // speed
  ...
  {  // speed_confidence
    ...
    assert(PyFloat_Check(field));
    ros_message->speed_confidence = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // steer_confidence
    PyObject * field = PyObject_GetAttrString(_pymsg, "steer_confidence");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->steer_confidence = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // source
...
PyObject * internal_interface__msg__control_input__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("internal_interface.msg._control_input");
  ...
  {  // speed_confidence
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->speed_confidence);
    {
  ...
  {  // steer_confidence
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->steer_confidence);
    {
      int rc = PyObject_SetAttrString(_pymessage, "steer_confidence", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
