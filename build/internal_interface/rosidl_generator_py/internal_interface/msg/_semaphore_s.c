...
bool internal_interface__msg__semaphore__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("internal_interface.msg._semaphore.Semaphore", full_classname_dest, 43) == 0);
  }
  internal_interface__msg__Semaphore * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of Semaphore */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("internal_interface.msg._semaphore");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Semaphore");
