...
bool internal_interface__msg__localized_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("internal_interface.msg._localized_object.LocalizedObject", full_classname_dest, 56) == 0);
  }
  internal_interface__msg__LocalizedObject * ros_message = _ros_message;
  {  // local_x
...
{
  /* NOTE(esteve): Call constructor of LocalizedObject */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("internal_interface.msg._localized_object");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LocalizedObject");
