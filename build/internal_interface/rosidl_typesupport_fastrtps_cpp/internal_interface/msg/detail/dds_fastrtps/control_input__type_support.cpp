...
#include "internal_interface/msg/detail/control_input__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const internal_interface::msg::ControlInput & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: steer_confidence
  cdr << ros_message.steer_confidence;
  // Member: source
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  internal_interface::msg::ControlInput & ros_message)
{
  // Member: speed
  cdr >> ros_message.speed;
  ...
  size_t current_alignment)
{
  ...
  // Member: speed_confidence
  {
    size_t item_size = sizeof(ros_message.speed_confidence);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: steer_confidence
  {
    size_t item_size = sizeof(ros_message.steer_confidence);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: source
...
{
  auto typed_message =
    static_cast<const internal_interface::msg::ControlInput *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<internal_interface::msg::ControlInput *>(
    untyped_ros_message);
...
static size_t _ControlInput__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ControlInput(full_bounded, 0);
}
...
{
  return &internal_interface::msg::typesupport_fastrtps_cpp::_ControlInput__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, internal_interface, msg, ControlInput)() {
  return &internal_interface::msg::typesupport_fastrtps_cpp::_ControlInput__handle;
}
