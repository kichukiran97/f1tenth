...
#include "internal_interface/msg/detail/localized_objects__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const internal_interface::msg::LocalizedObject &,
...
cdr_serialize(
  const internal_interface::msg::LocalizedObjects & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  internal_interface::msg::LocalizedObjects & ros_message)
{
  // Member: objects
  {
    uint32_t cdrSize;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_internal_interface
max_serialized_size_LocalizedObjects(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        internal_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_LocalizedObject(
...
{
  auto typed_message =
    static_cast<const internal_interface::msg::LocalizedObjects *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<internal_interface::msg::LocalizedObjects *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LocalizedObjects__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const internal_interface::msg::LocalizedObjects *>(
...
{
  return max_serialized_size_LocalizedObjects(full_bounded, 0);
}

static message_type_support_callbacks_t _LocalizedObjects__callbacks = {
...
static rosidl_message_type_support_t _LocalizedObjects__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LocalizedObjects__callbacks,
...
{
  return &internal_interface::msg::typesupport_fastrtps_cpp::_LocalizedObjects__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, internal_interface, msg, LocalizedObjects)() {
  return &internal_interface::msg::typesupport_fastrtps_cpp::_LocalizedObjects__handle;
}
