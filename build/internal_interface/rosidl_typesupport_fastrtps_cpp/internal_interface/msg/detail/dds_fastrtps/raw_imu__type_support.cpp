...
#include "internal_interface/msg/detail/raw_imu__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const internal_interface::msg::RawImu & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  internal_interface::msg::RawImu & ros_message)
{
  // Member: yaw
  cdr >> ros_message.yaw;
...
{
  auto typed_message =
    static_cast<const internal_interface::msg::RawImu *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<internal_interface::msg::RawImu *>(
    untyped_ros_message);
...
{
  return max_serialized_size_RawImu(full_bounded, 0);
}
...
{
  return &internal_interface::msg::typesupport_fastrtps_cpp::_RawImu__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, internal_interface, msg, RawImu)() {
  return &internal_interface::msg::typesupport_fastrtps_cpp::_RawImu__handle;
}
