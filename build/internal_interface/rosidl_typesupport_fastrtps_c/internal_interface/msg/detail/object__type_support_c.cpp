...
#include "internal_interface/msg/detail/object__rosidl_typesupport_fastrtps_c.h"
...
using _Object__ros_msg_type = internal_interface__msg__Object;
...
static uint32_t _Object__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_internal_interface__msg__Object(
...
{
  return max_serialized_size_internal_interface__msg__Object(
    full_bounded, 0);
}
