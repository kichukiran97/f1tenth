...
#include "internal_interface/msg/detail/localized_object__rosidl_typesupport_fastrtps_c.h"
...
using _LocalizedObject__ros_msg_type = internal_interface__msg__LocalizedObject;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _LocalizedObject__ros_msg_type * ros_message = static_cast<const _LocalizedObject__ros_msg_type *>(untyped_ros_message);
  // Field name: local_x
  {
  ...
  void * untyped_ros_message)
{
  ...
  _LocalizedObject__ros_msg_type * ros_message = static_cast<_LocalizedObject__ros_msg_type *>(untyped_ros_message);
  // Field name: local_x
  {
    cdr >> ros_message->local_x;
  }
...
static uint32_t _LocalizedObject__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_internal_interface__msg__LocalizedObject(
...
{
  return max_serialized_size_internal_interface__msg__LocalizedObject(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_LocalizedObject = {
...
static rosidl_message_type_support_t _LocalizedObject__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_LocalizedObject,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, internal_interface, msg, LocalizedObject)() {
  return &_LocalizedObject__type_support;
}
