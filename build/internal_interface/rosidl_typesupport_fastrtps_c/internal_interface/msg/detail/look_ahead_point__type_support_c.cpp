...
#include "internal_interface/msg/detail/look_ahead_point__rosidl_typesupport_fastrtps_c.h"
...
using _LookAheadPoint__ros_msg_type = internal_interface__msg__LookAheadPoint;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _LookAheadPoint__ros_msg_type * ros_message = static_cast<const _LookAheadPoint__ros_msg_type *>(untyped_ros_message);
  // Field name: alpha
  {
    cdr << ros_message->alpha;
  }

  // Field name: look_ahead_distance
  {
  ...
  void * untyped_ros_message)
{
  ...
  _LookAheadPoint__ros_msg_type * ros_message = static_cast<_LookAheadPoint__ros_msg_type *>(untyped_ros_message);
  // Field name: alpha
  {
    cdr >> ros_message->alpha;
  }
...
size_t get_serialized_size_internal_interface__msg__LookAheadPoint(
  const void * untyped_ros_message,
...
static uint32_t _LookAheadPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_internal_interface__msg__LookAheadPoint(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_internal_interface
size_t max_serialized_size_internal_interface__msg__LookAheadPoint(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_internal_interface__msg__LookAheadPoint(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_LookAheadPoint = {
...
static rosidl_message_type_support_t _LookAheadPoint__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_LookAheadPoint,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, internal_interface, msg, LookAheadPoint)() {
  return &_LookAheadPoint__type_support;
}
