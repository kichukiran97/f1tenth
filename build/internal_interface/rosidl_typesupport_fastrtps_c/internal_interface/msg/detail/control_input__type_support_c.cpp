...
#include "internal_interface/msg/detail/control_input__rosidl_typesupport_fastrtps_c.h"
...
using _ControlInput__ros_msg_type = internal_interface__msg__ControlInput;
...
static uint32_t _ControlInput__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_internal_interface__msg__ControlInput(
...
{
  return max_serialized_size_internal_interface__msg__ControlInput(
    full_bounded, 0);
}
