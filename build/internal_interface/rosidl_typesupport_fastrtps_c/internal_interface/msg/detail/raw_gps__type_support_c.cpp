...
#include "internal_interface/msg/detail/raw_gps__rosidl_typesupport_fastrtps_c.h"
...
using _RawGps__ros_msg_type = internal_interface__msg__RawGps;
...
size_t get_serialized_size_internal_interface__msg__RawGps(
  const void * untyped_ros_message,
...
static uint32_t _RawGps__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_internal_interface__msg__RawGps(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_internal_interface
size_t max_serialized_size_internal_interface__msg__RawGps(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_internal_interface__msg__RawGps(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, internal_interface, msg, RawGps)() {
