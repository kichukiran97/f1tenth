...
#include "internal_interface/msg/detail/goal_state__rosidl_typesupport_fastrtps_c.h"
...
using _GoalState__ros_msg_type = internal_interface__msg__GoalState;
...
size_t get_serialized_size_internal_interface__msg__GoalState(
  const void * untyped_ros_message,
...
static uint32_t _GoalState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_internal_interface__msg__GoalState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_internal_interface
size_t max_serialized_size_internal_interface__msg__GoalState(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_internal_interface__msg__GoalState(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, internal_interface, msg, GoalState)() {
