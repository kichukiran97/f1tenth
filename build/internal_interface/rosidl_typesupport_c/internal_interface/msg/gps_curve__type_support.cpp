...
static const _GpsCurve_type_support_symbol_names_t _GpsCurve_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, internal_interface, msg, GpsCurve)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, internal_interface, msg, GpsCurve)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, internal_interface, msg, GpsCurve)() {
  return &::internal_interface::msg::rosidl_typesupport_c::GpsCurve_message_type_support_handle;
}
