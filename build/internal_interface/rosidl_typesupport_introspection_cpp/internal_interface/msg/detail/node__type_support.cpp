...
{
  new (message_memory) internal_interface::msg::Node(_init);
}

void Node_fini_function(void * message_memory)
{
  auto typed_message = static_cast<internal_interface::msg::Node *>(message_memory);
  typed_message->~Node();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Node_message_member_array[3] = {
  {
    ...
    offsetof(internal_interface::msg::Node, node_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(internal_interface::msg::Node, map_x),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(internal_interface::msg::Node, map_y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Node_message_members = {
  ...
  "Node",  // message name
  3,  // number of fields
  sizeof(internal_interface::msg::Node),
...
{
  return &::internal_interface::msg::rosidl_typesupport_introspection_cpp::Node_message_type_support_handle;
}
