...
static const _RawImu_type_support_symbol_names_t _RawImu_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, internal_interface, msg, RawImu)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, internal_interface, msg, RawImu)),
  }
};
...
get_message_type_support_handle<internal_interface::msg::RawImu>()
{
  return &::internal_interface::msg::rosidl_typesupport_cpp::RawImu_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, internal_interface, msg, RawImu)() {
  return get_message_type_support_handle<internal_interface::msg::RawImu>();
}
