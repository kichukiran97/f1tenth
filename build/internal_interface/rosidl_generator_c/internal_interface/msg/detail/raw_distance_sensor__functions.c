...
internal_interface__msg__RawDistanceSensor__create()
{
  ...
  internal_interface__msg__RawDistanceSensor * msg = (internal_interface__msg__RawDistanceSensor *)allocator.allocate(sizeof(internal_interface__msg__RawDistanceSensor), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(internal_interface__msg__RawDistanceSensor));
  bool success = internal_interface__msg__RawDistanceSensor__init(msg);
  if (!success) {
...
internal_interface__msg__RawDistanceSensor__destroy(internal_interface__msg__RawDistanceSensor * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    internal_interface__msg__RawDistanceSensor__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
internal_interface__msg__RawDistanceSensor__Sequence__init(internal_interface__msg__RawDistanceSensor__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  internal_interface__msg__RawDistanceSensor * data = NULL;

  if (size) {
    data = (internal_interface__msg__RawDistanceSensor *)allocator.zero_allocate(size, sizeof(internal_interface__msg__RawDistanceSensor), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = internal_interface__msg__RawDistanceSensor__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        internal_interface__msg__RawDistanceSensor__fini(&data[i - 1]);
      }
...
internal_interface__msg__RawDistanceSensor__Sequence__fini(internal_interface__msg__RawDistanceSensor__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      internal_interface__msg__RawDistanceSensor__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  internal_interface__msg__RawDistanceSensor__Sequence * array = (internal_interface__msg__RawDistanceSensor__Sequence *)allocator.allocate(sizeof(internal_interface__msg__RawDistanceSensor__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = internal_interface__msg__RawDistanceSensor__Sequence__init(array, size);
  if (!success) {
...
internal_interface__msg__RawDistanceSensor__Sequence__destroy(internal_interface__msg__RawDistanceSensor__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    internal_interface__msg__RawDistanceSensor__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
internal_interface__msg__RawDistanceSensor__Sequence__are_equal(const internal_interface__msg__RawDistanceSensor__Sequence * lhs, const internal_interface__msg__RawDistanceSensor__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!internal_interface__msg__RawDistanceSensor__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  internal_interface__msg__RawDistanceSensor__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(internal_interface__msg__RawDistanceSensor);
    internal_interface__msg__RawDistanceSensor * data =
      (internal_interface__msg__RawDistanceSensor *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!internal_interface__msg__RawDistanceSensor__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          internal_interface__msg__RawDistanceSensor__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!internal_interface__msg__RawDistanceSensor__copy(
