...
internal_interface__msg__GoalState__are_equal(const internal_interface__msg__GoalState * lhs, const internal_interface__msg__GoalState * rhs)
{
  ...
  // goal_node_id
  if (lhs->goal_node_id != rhs->goal_node_id) {
    return false;
  }
  return true;
}
  ...
  internal_interface__msg__GoalState * output)
{
  ...
  // goal_node_id
  output->goal_node_id = input->goal_node_id;
  return true;
}
...
internal_interface__msg__GoalState__create()
{
  ...
  internal_interface__msg__GoalState * msg = (internal_interface__msg__GoalState *)allocator.allocate(sizeof(internal_interface__msg__GoalState), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(internal_interface__msg__GoalState));
  bool success = internal_interface__msg__GoalState__init(msg);
  if (!success) {
...
internal_interface__msg__GoalState__destroy(internal_interface__msg__GoalState * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    internal_interface__msg__GoalState__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
internal_interface__msg__GoalState__Sequence__init(internal_interface__msg__GoalState__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  internal_interface__msg__GoalState * data = NULL;

  if (size) {
    data = (internal_interface__msg__GoalState *)allocator.zero_allocate(size, sizeof(internal_interface__msg__GoalState), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = internal_interface__msg__GoalState__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        internal_interface__msg__GoalState__fini(&data[i - 1]);
      }
...
internal_interface__msg__GoalState__Sequence__fini(internal_interface__msg__GoalState__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      internal_interface__msg__GoalState__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  internal_interface__msg__GoalState__Sequence * array = (internal_interface__msg__GoalState__Sequence *)allocator.allocate(sizeof(internal_interface__msg__GoalState__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = internal_interface__msg__GoalState__Sequence__init(array, size);
  if (!success) {
...
internal_interface__msg__GoalState__Sequence__destroy(internal_interface__msg__GoalState__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    internal_interface__msg__GoalState__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
internal_interface__msg__GoalState__Sequence__are_equal(const internal_interface__msg__GoalState__Sequence * lhs, const internal_interface__msg__GoalState__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!internal_interface__msg__GoalState__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  internal_interface__msg__GoalState__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(internal_interface__msg__GoalState);
    internal_interface__msg__GoalState * data =
      (internal_interface__msg__GoalState *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!internal_interface__msg__GoalState__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          internal_interface__msg__GoalState__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!internal_interface__msg__GoalState__copy(
